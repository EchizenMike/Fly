...
$result = mysqli_query($conn,"SELECT * FROM admin_table WHERE Username='$user' and Password='$pass'");
...
//  echo "</SCRIPT>";
     mysqli_query($conn,"UPDATE admin_table SET log_dev = log_dev + 1 WHERE username='$user'");
     $json = array();
   	 $json['result'] = '1';
   	 echo json_encode($json);
}else{
